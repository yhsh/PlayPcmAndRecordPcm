 ...
 * @author DELL
 */
public class KSongWriteReadMainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.playAudio:
                //两个一起播放
                PlayByteManagerUtil.getInstance().playPcm(isChecked);
            ...
            case R.id.stopVoice:
                ...
                //暂停原声播放
                PlayByteManagerUtil.getInstance().setPlayStatus(playStatue);
                break;
    ...
    private void deleteFile() {
        File recordFile = PlayByteManagerUtil.getInstance().getRecordFile();
        if (recordFile == null) {
            return;
        }
        recordFile.delete();
